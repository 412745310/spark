...
public class SparkStreamWindowTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SparkConf conf = new SparkConf().setMaster("local[2]").setAppName("SparkStreamWindowTest");
        JavaSparkContext sc = new JavaSparkContext(conf);
        // 设置checkpoint保存历史数据
        // sc.setCheckpointDir("hdfs://172.18.20.237:9000/input/checkpoint/sparkStreamCheckPoint");
        sc.setCheckpointDir("C:/Users/Administrator/Desktop/SparkStreamWindowTest");
        // 设置日志级别
        ...
        // 对每个key每隔5秒统计前15秒的数据，每次只对新进window的数据做增加，对移除window的数据做减少
        JavaPairDStream<String, Integer> resultPairDS =
                wordPairDS.reduceByKeyAndWindow(new Function2<Integer, Integer, Integer>() {
        ...
        resultPairDS.foreachRDD(new VoidFunction<JavaPairRDD<String, Integer>>() {
            ...
            public void call(JavaPairRDD<String, Integer> rdd) throws Exception {
                JavaPairRDD<String, Integer> mapToPair =
